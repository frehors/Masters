...
path = r'C:\Users\frede\Entsoe_SFTP\new_imports\entsoe_prices\DayAheadPrices_12.1.D'
date_range_monthly = pd.date_range(start='2015-01-01', end='2022-12-31', freq='MS')
folder = 'DayAheadPrices_12.1.D'
keep_cols = ['DateTime', 'MapCode', 'Price', 'ResolutionCode']
big_df = pd.DataFrame()
...
# save big_df0
save_path = r'C:\Users\frede\PycharmProjects\Masters\data\data\Entsoe_DayAheadPrices\\'
